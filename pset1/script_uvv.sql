...
--agora saia do usuário postgres com: exit
--entre no diretorio de documentos no usuario computacao: cd Documents
--execute o comando: psql -U postgres < nome_do_arquivo
--digitar senha administrativa do BD: computacao@raiz
